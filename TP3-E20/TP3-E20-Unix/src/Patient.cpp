...
{
	stream << "Patient: ";
	std::string typePatient;// TODO: Chercher le nom de la classe Consulation. Utiliser typeid().name() puis Extraire le nom de la classe du string  en utilisant la fonction fournie dans utils.h
